...
class MinorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create minor" do
    assert_difference('Minor.count') do
      post minors_url, params: { minor: { city: @minor.city, faculty: @minor.faculty, name: @minor.name, page_url: @minor.page_url } }
    end
  ...
  test "should update minor" do
    patch minor_url(@minor), params: { minor: { city: @minor.city, faculty: @minor.faculty, name: @minor.name, page_url: @minor.page_url } }
